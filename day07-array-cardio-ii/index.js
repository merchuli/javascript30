...
console.log('Array.prototype.some()', isAdult);


// Array.prototype.every() // is everyone 19 or older?
const isAllAdults = people.every((person) => ((new Date()).getFullYear() - person.year) >= 19);
console.log('Array.prototype.every()', isAllAdults);
...
console.log('Array.prototype.find()', target);
...
console.log('findIndex', targetIndex);
